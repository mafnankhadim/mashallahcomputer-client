const services = [
  ...
  {
    id: 15,
    title: "New & Used Mobile Phone Sales",
    description:
      "Buy new and inspected pre-owned mobile phones with warranty and trade-in options.",
  },
  {
    id: 16,
    title: "Mobile Software Services",
    description:
      "Software installation, OS updates, app setup, data transfer and mobile optimisation services.",
  },
  {
    id: 17,
    title: "Screen Protector & Tempered Glass",
    description:
      "Professional fitting of screen protectors and tempered glass for all popular phone models.",
  },
  {
    id: 18,
    title: "Battery & Charging Repair",
    description:
      "Battery replacement and charging port repair to restore reliable power and charging performance.",
  },
  {
    id: 19,
    title: "Data Transfer & Backup",
    description:
      "Secure data transfer, cloud backup setup, and local backup services to protect your contacts and media.",
  },
  {
    id: 20,
    title: "Phone Unlocking & SIM/Network Services",
    description:
      "SIM configuration, network troubleshooting, and phone unlocking services for local and international use.",
  },
];
